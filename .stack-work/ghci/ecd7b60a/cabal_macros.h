...
/* package happstack-jmacro-7.0.12.2 */
#ifndef VERSION_happstack_jmacro
#define VERSION_happstack_jmacro "7.0.12.2"
#endif /* VERSION_happstack_jmacro */
#ifndef MIN_VERSION_happstack_jmacro
#define MIN_VERSION_happstack_jmacro(major1,major2,minor) (\
  (major1) <  7 || \
  (major1) == 7 && (major2) <  0 || \
  (major1) == 7 && (major2) == 0 && (minor) <= 12)
#endif /* MIN_VERSION_happstack_jmacro */

/* package happstack-server-7.6.1 */
#ifndef VERSION_happstack_server
#define VERSION_happstack_server "7.6.1"
#endif /* VERSION_happstack_server */
#ifndef MIN_VERSION_happstack_server
#define MIN_VERSION_happstack_server(major1,major2,minor) (\
  (major1) <  7 || \
  (major1) == 7 && (major2) <  6 || \
  (major1) == 7 && (major2) == 6 && (minor) <= 1)
...
#define CURRENT_COMPONENT_ID "AVSim-0.1.0.0-8uRT2l5Natb8aJl7p1WKAn-AVSim"
